...
![Coverage badge](https://raw.githubusercontent.com/yukihouse/claude-sandbox/python-coverage-comment-action-data-exe-checker/badge.svg)
...
The [`exe-checker-coverage.yml`](../.github/workflows/exe-checker-coverage.yml)
workflow runs this project's test suite with coverage whenever a pull
request or push to `main` touches `exe-checker/`, and posts (and updates)
